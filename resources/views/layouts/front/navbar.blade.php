<div class="logo-nav">
    <div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
        <h1><a href="{{route('welcome')}}">Best Store <span>Shop anywhere</span></a></h1>
    </div>
 ...
 <li><a href="{{route('Front.produit',$category->id)}}">
    {{$category->nom}}</a></li>         
                    @endforeach
     ...
     <div class="header-right">
        <div class="cart box_1">
            <a href="{{route('cart.index')}}" >
                <h3> <div >
                    <span>{{ Cart::total() }} Dt</span> ({{ Cart::content()->count() }} items)</div>
                    <img src="{{asset('images/front/bag.png')}}" alt="" />
                </h3>
                    <img src="images/bag.png" alt="" />
                </h3>
            </a>
            <p><a href="{{route('cart.index')}}" class="simpleCart_empty">Panier
